...
DATASETS = {
	'ffhq_encode': {
		...
		'train_source_root': dataset_paths['trump_train'],
		'train_target_root': dataset_paths['trump_train'],
		'test_source_root': dataset_paths['trump_test'],
		'test_target_root': dataset_paths['trump_test'],
	},
	# 'ffhq_frontalize': {
